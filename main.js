...
Mymodle = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/1zjvf3X6I/model.json',modelLoaded)
...
function gotResult(error,results){
    if(error){console.log(error)}
        ...
        document.getElementById("acc").innerHTML=results[0].confidence.toFixed(4)
